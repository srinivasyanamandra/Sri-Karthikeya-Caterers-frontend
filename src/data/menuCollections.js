...
const menuCollections = [
  ...
  /* ───────────────────────── ROYAL FEAST ───────────────────── */
  {
    ...
    image: 'https://content.jdmagicbox.com/v2/comp/asansol/k9/9999px341.x341.251129071358.y6k9/catalogue/royal-feast-sarakdihi-asansol-pure-veg-restaurants-pxnydlwoy3.jpg',
  ...
  /* ───────────────────────── FESTIVE SPREAD ──────────────────── */
  {
    ...
    image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQyLayZr5SLciTvFwmB8ZCmjgvQhGZrDrF9MQ&s',
...
export const TOTAL_COLLECTION_DISHES = menuCollections.reduce(
  (total, col) =>
    ...
    col.pages.reduce(
      (pageTotal, page) =>
        pageTotal +
        page.sections.reduce((secTotal, sec) => secTotal + sec.items.length, 0),
      0
    ),
  0
);
