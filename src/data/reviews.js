...
const reviews = [
  {
    ...
    review: 'Exceptional quality and authentic taste. Their attention to detail and commitment to excellence is truly commendable. We have worked with them on multiple occasions.',
  ...
  },
  {
    ...
    review: 'Outstanding service and delicious food. They understand the importance of quality and consistency in every event. That Telugu inti avakaya ruchi — I couldn\'t forget it for a lifetime. Highly recommended for any occasion.',
  ...
  },
  {
    ...
    review: 'Trusted for high-profile gatherings. Their discretion, quality and ability to handle large-scale events with precision is remarkable. Excellent coordination throughout.',
  ...
  },
  {
    ...
    review: 'Our grand NRI wedding with 2,000 guests was flawlessly executed. The food was exceptional and the service impeccable — an unforgettable celebration.',
  ...
  },
  {
    ...
    review: 'Engaged Sri Karthikeya for an official function with senior dignitaries. Their attention to dietary protocol, timely service and consistent quality across courses earned them a permanent place on our preferred-vendors list.',
